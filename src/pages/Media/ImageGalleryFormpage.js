...
const ImageGalleryFormpage = () => {
  const handleClick = () => {
    window.location.href = '/imagegalleryview';
  };
            ...
            <div className='news-form'>
              ...
              <Form>
                <div className='custom-input'>
                  <label>Image Gallery category*</label>
                ...
                <div className='custom-input'>
                  <label>
                    Image Gallery Banner Image<span>(1Mb)</span>*
                  </label>
...
export default ImageGalleryFormpage;
